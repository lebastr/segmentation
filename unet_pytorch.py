...
class Decoder1(nn.Module):
    def __init__(self):
        ...
        self.bottleneck = conv_relu(512, 1024, 512)
        self.merge1 = MergeBlock1(4, 512)
        self.merge2 = MergeBlock1(18, 256)
        self.merge3 = MergeBlock1(46, 128)
        self.merge4 = MergeBlock1(100, 64, out_channels=64)
...
class MergeBlock1(nn.Module):
    def __init__(self, crop_size, in_channels, out_channels=None):
        ...
        super(MergeBlock1, self).__init__()

        self.crop_size = crop_size
        self.upsample = nn.Upsample(scale_factor=2)
        self.conv = conv_relu(2 * in_channels, in_channels, out_channels)
...
def conv_relu(in_channels, middle_channels, out_channels):
    x0 = nn.BatchNorm2d(in_channels)
    x1 = nn.Conv2d(in_channels, middle_channels, 3)
    x3 = nn.ReLU()
    x4 = nn.Conv2d(middle_channels, out_channels, 3)
    x6 = nn.ReLU()

    return nn.Sequential(x0,x1,x3,x4,x6)
...
class Decoder2(nn.Module):
    def __init__(self):
        ...
        self.bottleneck = conv_relu(512, 1024, 512)
        self.merge1 = MergeBlock2(4, 512)
        self.merge2 = MergeBlock2(18, 256)
        self.merge3 = MergeBlock2(46, 128)
        self.merge4 = MergeBlock2(100, 64, out_channels=64)
...
class MergeBlock2(nn.Module):
    def __init__(self, crop_size, in_channels, out_channels=None):
        ...
        super(MergeBlock2, self).__init__()
